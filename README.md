...
3.批量用户导入数据库（将人脸向量特征序列化后存入sqlite3，dlib人脸特征向量为精度128位的浮点数，序列化后可能丢失精度，可使用专门的向量数据库库避免丢失精度。__后续使用orm替换裸写的sql语句，SQLAlchemy?SQLObject?Storm?peewee?__<br>
...
xlrd                    1.2.0 <br> 
PyQtChart               5.15.5<br>
![](https://github.com/gitlGl/dlib_face_recognition/blob/master/Screenshot/%E6%95%B0%E6%8D%AE.png) <br>
