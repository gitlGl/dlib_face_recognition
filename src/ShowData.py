...
class ShowData(QWidget):
    def __init__(self):
        ...
        self.btn_analyzeData.setIcon(QIcon("resources/分析.png"))
        self.btn_Search = QPushButton()
        self.btn_Search = QPushButton(objectName="GreenButton")
        self.btn_Search.setIcon(QIcon("resources/搜索.png"))
        ...
        self.btn_brow.setIcon(QIcon("resources/浏览.png"))
        self.btn_create_user = QPushButton()
        self.btn_create_user = QPushButton(objectName="GreenButton")
        self.btn_create_user.setIcon(QIcon("resources/文件.png"))
        ...
        self.btn_plugin.setIcon(QIcon("resources/插件.png"))
