...
from .model import StudentLogTime,Student
class ShowData(QWidget):
    ...
    def getData_(self):
        ...
        #  between '{0}'  and '{1}';"
        sql_female = "SELECT count(id_number)  FROM student_log_time where log_time like  '{0}%'    and gender = '女';"
        sql_male = "SELECT count(id_number)  FROM student_log_time where log_time like  '{0}%'    and gender = '男';"
        sql = "SELECT count(id_number)  FROM student_log_time where log_time \
         like '{0}%';"
    ...
    def getData(self,days,step):
        ...
        female_data = []
        male_data = []
        sql_female = "SELECT count(id_number)  FROM student_log_time where log_time between  '{0}'   and '{1}' and gender ='女';"
        sql_male = "SELECT count(id_number)  FROM student_log_time where log_time between  '{0}'   and '{1}' and gender ='男';"
        sql = "SELECT count(id_number)  FROM student_log_time where log_time \
         between '{0}'  and '{1}';"
